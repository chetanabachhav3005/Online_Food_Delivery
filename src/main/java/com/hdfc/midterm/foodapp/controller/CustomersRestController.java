...
public class CustomersRestController {
	...
	public ResponseEntity<Customers> removeCustomer(@PathVariable("customerId") Long customerId) throws CustomerException{
	...
	public ResponseEntity<Customers> viewCustomer(@PathVariable("customerId") Long customerId) throws CustomerException{
